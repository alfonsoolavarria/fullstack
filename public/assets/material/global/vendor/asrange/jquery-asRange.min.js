...
! function(t, e) {
  ...
  var n = e(t),
    ...
    u = function() {
      function t(e, s, a) {
        i(this, t), this.$element = e, this.uid = s, this.parent = a, this.options = n.default.extend(!0, {}, this.parent.options), this.direction = this.options.direction, this.value = null, this.classes = {
      ...
      return o(t, [{
        ...
        value: function(t) {
          var e = this.parent.direction.axis,
            i = this.parent.direction.position,
          ...
          return this.set(o), n.default.each(this.parent.pointer, function(t, e) {
            ...
            var i = s(t),
              n = this.parent.getValueFromPosition(this.data.position + (i[e] || this.data.start) - this.data.start);
    ...
    l = {
      ...
      init: function(t) {
        var e = n.default.extend({}, this.defaults, t.options.scale),
          i = e.scale;
        ...
        var o = {
          ...
          r = i.values.length,
          u = ((i.grid - 1) * (i.gap + 1) + i.gap) * (r - 1) + r,
          l = 100 / (u - 1),
          h = 100 / (r - 1);
        ...
        for (var p = 0; p < u; p++) {
          var c = void 0;
          c = 0 === p || p === u || p % ((u - 1) / (r - 1)) === 0 ? (0, n.default)('<li class="' + o.grid + '"></li>') : p % i.grid === 0 ? (0, n.default)('<li class="' + o.inlineGrid + '"></li>') : (0, n.default)("<li></li>"), c.css({
            left: l * p + "%"
          }).appendTo(this.$lines)
        }
        for (var d = 0; d < r; d++)(0, n.default)("<li><span>" + i.values[d] + "</span></li>").css({
          left: h * d + "%"
        ...
        value: function() {
          ...
          this.$wrap.on("touchstart.asRange mousedown.asRange", function(t) {
            if (e.disabled !== !0) {
              ...
              if (i) return !1;
              var n = e.$wrap.offset(),
                a = t[e.direction.axis] - n[e.direction.position],
                o = e.getAdjacentPointer(a);
