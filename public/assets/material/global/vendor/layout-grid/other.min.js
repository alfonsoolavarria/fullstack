/*! gridster.js - v0.7.0 - 2017-03-27 - * https://dsmorse.github.io/gridster.js/ - Copyright (c) 2017 ducksboard; Licensed MIT */ ! function(a, b) {
  "use strict";
...
function(a, b) {
  ...
  return e.init = function() {
    ...
    return a({
      left: d,
      top: e,
      width: Math.min(b.x2, c.x2) - d,
      height: Math.min(b.y2, c.y2) - e
    }).coords().get()
  }, e.calculate_overlapped_area = function(a) {
    return a.width * a.height
  }, e.manage_colliders_start_stop = function(b, c, d) {
    for (var e = this.last_colliders_coords, f = 0, g = e.length; f < g; f++) a.inArray(e[f], b) === -1 && c.call(this, e[f]);
...
function(a, b) {
  ...
  return h.init = function() {
    ...
    return e < 0 ? (this.get_min_col() > e * -1 ? this.shift_cols(e) : this.resize_widget_dimensions(this.options), setTimeout(a.proxy(function() {
    ...
    a.each(f.cols, function(b, c) {
      a.inArray(c, g.cols) === -1 && h.push(c)
    });
    var i = [];
    a.each(g.cols, function(b, c) {
      a.inArray(c, f.cols) === -1 && i.push(c)
    });
    var j = [];
    a.each(f.rows, function(b, c) {
      a.inArray(c, g.rows) === -1 && j.push(c)
    });
    var k = [];
    if (a.each(g.rows, function(b, c) {
        a.inArray(c, f.rows) === -1 && k.push(c)
    ...
    return this.resize_api = this.$el.gridDraggable({
      ...
      resize: !0,
      limit: {
        width: this.options.max_cols !== 1 / 0 || this.limit.width,
        height: this.options.max_rows !== 1 / 0 || this.limit.height
      },
      scroll_container: this.options.scroll_container,
    ...
    return void 0 === this.gridmap[a] || void 0 !== this.gridmap[a][b] && this.gridmap[a][b] === !1
    ...
    for (e = d, e = 1; e < h; e++) {
      for (var i = !0, j = 0, k = g.length; j < k; j++) g[j] && a.inArray(e, g[j]) === -1 && (i = !1);
      if (i === !0) {
        f = e;
        break
      }
    ...
    return this.for_each_column_occupied(e, function(b) {
      f.for_each_widget_below(b, g, function(b, d) {
        if (!f.is_player(this) && a.inArray(this, c) === -1) return c = c.add(this), !0
      })
    }), d.sort_by_row_asc(c)
      ...
      var l = [],
        ...
        n = {
          "for_each/above": function() {
            for (; m-- && !(m > 0 && this.is_widget(d, m) && a.inArray(g[d][m], l) === -1 && (h = f.call(g[d][m], d, m), l.push(g[d][m]), h)););
          },
          "for_each/below": function() {
            for (m = e + 1, i = g[d].length; m < i; m++) this.is_widget(d, m) && a.inArray(g[d][m], l) === -1 && (h = f.call(g[d][m], d, m), l.push(g[d][m]))
          }
        };
      n[j] && n[j].call(this)
    }
